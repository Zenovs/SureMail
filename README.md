...
|---|---|
| **x64** (Standard-PC) | [⬇️ CoreMail-Desktop-4.8.0-x86_64.AppImage](https://github.com/Zenovs/coremail/releases/latest) |
| **arm64** (Raspberry Pi 4/5) | [⬇️ CoreMail-Desktop-4.8.0-arm64.AppImage](https://github.com/Zenovs/coremail/releases/latest) |
