...
Oder manuell: **[CoreMail.Desktop-2.2.1.AppImage](https://github.com/Zenovs/coremail/releases)**

```bash
chmod +x CoreMail.Desktop-2.2.1.AppImage
./CoreMail.Desktop-2.2.1.AppImage
```
