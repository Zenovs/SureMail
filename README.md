...
|---|---|
| **x64** (Standard-PC) | [⬇️ CoreMail-Desktop-4.3.3-x64.AppImage](https://github.com/Zenovs/coremail/releases/download/v4.3.3/CoreMail-Desktop-4.3.3-x64.AppImage) |
| **arm64** (Raspberry Pi 4/5) | [⬇️ CoreMail-Desktop-4.3.3-arm64.AppImage](https://github.com/Zenovs/coremail/releases/download/v4.3.3/CoreMail-Desktop-4.3.3-arm64.AppImage) |
